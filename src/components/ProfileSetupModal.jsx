...
const ProfileSetupModal = ({ user, isOpen, onSubmit }) => {
          ...
          <form onSubmit={handleSubmit} className="px-6 sm:px-8 py-6 space-y-6">
              ...
              <div className="bg-blue-50/50 border border-blue-200 rounded-xl p-4">
                <label className="flex items-center gap-3 cursor-pointer">
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("isNonTeachingStaff", e.target.checked)
                    }
            ...
            <div>
              ...
              <div className="relative mb-3">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-sm"
            ...
            <div className="pt-4">
              <button
                ...
                className="w-full px-6 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed transform hover:scale-105 disabled:hover:scale-100"
              >
                {isSubmitting
                  ? "Setting up profile..."
